...
const Appionment = () => {
  return (
    <section className='bg-[url(/images/contact_bg.png)] py-20 md:py-28 bg-cover bg-center rounded-t-3xl sm:rounded-t-[50px] md:rounded-t-[70px] lg:rounded-t-[100px] xl:rounded-t-[140px]'>
